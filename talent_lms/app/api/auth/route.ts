...
function authUnavailableResponse() {
  return NextResponse.json(
    {
      error:
        "Authentication service is unavailable. Check your Supabase URL, keys, and network access.",
    },
    { status: 503 }
  );
}
  ...
  try {
    ...
    if (action === "signup") {
      ...
      try {
        ...
        console.error("Error during employer insert or updateUserById:", error);
